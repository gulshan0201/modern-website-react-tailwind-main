        ...
        <nav className="container  flex h-[70px] items-center justify-between py-2 ">
          <div className="text-2xl text-white md:text-3xl ">
            <a href="/#home" className="">
              SAM
              <span className="inline-block font-bold text-primary">PLE</span>
            </a>
          </div>
          {/* Desktop Menu */}
                  ...
                  <div className="grid grid-cols-3 gap-5 ">
                    <div className="d-200 overflow-hidden">
                      <img
                        ...
                        src="https://thumbs.dreamstime.com/b/men-packing-chair-plastic-two-young-male-movers-packing-furniture-plastic-wrap-living-room-182283395.jpg"
                        alt="pics"
                      />
                    </div>
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600">
                        ...
                        elit. eprehenderit doloribus, numquam
                        corporis quae.
                      </p>
                      <div className="grid grid-cols-3 ">
                        ...
                        <div>
                          <img src="https://img2.exportersindia.com/product_images/bc-full/2021/3/8347035/packaging-services-1614931377-5744293.jpeg" alt="no image" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <li>
                  <div>
                    ...
                    <p className="text-lg">
                      {" "}
                      <a href="tel:+91123456789">+91 XXXXXXXX</a>
                    </p>
                  </div>
                </li>
              </div>
